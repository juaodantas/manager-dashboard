...
export class Initial1743450000000 implements MigrationInterface {
  name = 'Initial1743450000000'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "services_forma_pagamento_enum"`)
    await queryRunner.query(`DROP TYPE "services_status_enum"`)
    await queryRunner.query(`DROP TYPE "services_tipo_enum"`)
